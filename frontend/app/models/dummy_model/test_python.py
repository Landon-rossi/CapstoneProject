...
def visualize_data(data, norm, method, y):
    ...
    plt.title(f"{title} of {norm} Iris Dataset")
    plt.show()
...
# Compare visualizations for t-SNE
...
# No Google Colab mounting needed – using local directory
import os
